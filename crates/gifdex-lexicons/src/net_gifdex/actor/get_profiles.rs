...
//
// Lexicon: net.gifdex.actor.getProfiles
//
...
pub struct GetProfiles<'a> {
    #[serde(borrow)]
    pub actors: Vec<jacquard_common::types::string::Did<'a>>,
}
...
pub struct GetProfilesOutput<'a> {
    #[serde(borrow)]
    pub profiles: Vec<crate::net_gifdex::actor::ProfileView<'a>>,
}

/// Response type for
///net.gifdex.actor.getProfiles
pub struct GetProfilesResponse;
impl jacquard_common::xrpc::XrpcResp for GetProfilesResponse {
    const NSID: &'static str = "net.gifdex.actor.getProfiles";
...
impl jacquard_common::xrpc::XrpcEndpoint for GetProfilesRequest {
    const PATH: &'static str = "/xrpc/net.gifdex.actor.getProfiles";
    const METHOD: jacquard_common::xrpc::XrpcMethod = jacquard_common::xrpc::XrpcMethod::Query;
