...
//
// Lexicon: net.gifdex.actor.profile
//
...
impl jacquard_common::types::collection::Collection for Profile<'_> {
    const NSID: &'static str = "net.gifdex.actor.profile";
...
impl<'a> ::jacquard_lexicon::schema::LexiconSchema for Profile<'a> {
    fn nsid() -> &'static str {
        "net.gifdex.actor.profile"
    }
    fn def_name() -> &'static str {
        "main"
    }
    fn lexicon_doc() -> ::jacquard_lexicon::lexicon::LexiconDoc<'static> {
        lexicon_doc_net_gifdex_actor_profile()
    }
    fn validate(
        &self,
...
fn lexicon_doc_net_gifdex_actor_profile() -> ::jacquard_lexicon::lexicon::LexiconDoc<
    'static,
> {
    ::jacquard_lexicon::lexicon::LexiconDoc {
        lexicon: ::jacquard_lexicon::lexicon::Lexicon::Lexicon1,
        id: ::jacquard_common::CowStr::new_static("net.gifdex.actor.profile"),
        revision: None,
        description: None,
        defs: {
