...
//
// Lexicon: net.gifdex.actor.getProfile
//
...
pub struct GetProfileOutput<'a> {
    #[serde(flatten)]
    #[serde(borrow)]
    pub value: crate::net_gifdex::actor::ProfileView<'a>,
}
...
pub enum GetProfileError<'a> {
    /// The requested profile does not exist or has not been indexed yet.
...
/// Response type for
///net.gifdex.actor.getProfile
pub struct GetProfileResponse;
impl jacquard_common::xrpc::XrpcResp for GetProfileResponse {
    const NSID: &'static str = "net.gifdex.actor.getProfile";
...
impl jacquard_common::xrpc::XrpcEndpoint for GetProfileRequest {
    const PATH: &'static str = "/xrpc/net.gifdex.actor.getProfile";
    const METHOD: jacquard_common::xrpc::XrpcMethod = jacquard_common::xrpc::XrpcMethod::Query;
